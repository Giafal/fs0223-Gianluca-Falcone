...
console.log(isThisAnEmail("gianluca.falcone@yahoo.it"));
...
console.log(howManyDays(new Date(2020, 1, 1)));
...
console.log(
  deleteProp({ name: "Gianluca", surname: "Falcone", age: 35 }, "surname")
);
