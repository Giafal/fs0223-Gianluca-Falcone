...
class MuratoreAutonomo extends LavoratoreAutonomo {
  ...
  getRedditoAnnuoNetto(): void {
    let redditoNetto =
      this.redditoAnnuoLordo - (this.getTasselnps() + this.getTasselrpef());
...
console.log(
  "Hai pagato all'INPS: " + AlfredoMuratoreAutonomo.getTasselnps() + "$"
);
console.log(
  "Hai pagato per l'IRPEF: " + AlfredoMuratoreAutonomo.getTasselrpef() + "$"
);
